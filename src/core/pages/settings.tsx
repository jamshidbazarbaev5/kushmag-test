...
export default function SettingsPage() {
  ...
  const handleSyncAll = async (selectedModels: string[]) => {
    try {
      await syncAllMutation.mutateAsync({ models: selectedModels });
                  ...
                  >
                    <div className="flex items-center space-x-4">
                      ...
                      <div>
                        ...
                        {log.synced_models_translation &&
                          log.synced_models_translation.length > 0 && (
                            <div className="text-xs text-gray-600 mt-1">
                              {log.synced_models_translation.join(" • ")}
                            </div>
                          )}
                      </div>
                    </div>
                ...
                <div className="mt-6 flex justify-center">
                  <div className="flex items-center space-x-1">
                    ...
                    <span className="px-3 py-1 text-sm text-gray-600">
                      {syncLogsPage} / {Math.ceil(syncLogsData.count / 10)}
                    </span>
                    <button
