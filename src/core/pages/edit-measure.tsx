...
export default function EditMeasure() {
  ...
  const handleRemoveExtension = (doorIdx: number, extIdx: number) => {
    setDoors((prev) =>
      prev.map((d, i) =>
        i === doorIdx
          ? { ...d, extensions: d.extensions.filter((_, j) => j !== extIdx) }
          : d,
      ),
    );
  };
    ...
    setDoors((prev) =>
      prev.map((d, i) =>
        i === doorIdx
          ? {
              ...d,
              extensions: d.extensions.map((ext, j) =>
                j === extIdx ? { ...ext, [field]: value } : ext,
              ),
            }
          : d,
      ),
  ...
  const handleRemoveCrown = (doorIdx: number, crownIdx: number) => {
    setDoors((prev) =>
      prev.map((d, i) =>
        i === doorIdx
          ? { ...d, crowns: d.crowns.filter((_, j) => j !== crownIdx) }
          : d,
      ),
    );
  };
    ...
    setDoors((prev) =>
      prev.map((d, i) =>
        i === doorIdx
          ? {
              ...d,
              crowns: d.crowns.map((c, j) =>
                j === crownIdx ? { quantity: value } : c,
              ),
            }
          : d,
      ),
                ...
                <TableRow>
                  ...
                  <TableCell>
                    <Select
                      ...
                      onValueChange={(value) =>
                        form.setValue("zamer_status", value)
                      }
                    >
                    ...
                    <TableRow key={idx}>
                      ...
                      <TableCell>
                        <Input
                          ...
                          onChange={(e) =>
                            handleDoorChange(idx, "room_name", e.target.value)
                          }
                      ...
                      <TableCell>
                        <Select
                          value={door.glass_type?.toString() || ""}
                          onValueChange={(v) =>
                            handleDoorChange(idx, "glass_type", v)
                          }
                        >
                      ...
                      <TableCell>
                        <Select
                          value={door.opening_side}
                          onValueChange={(v) =>
                            handleDoorChange(idx, "opening_side", v)
                          }
                        >
                      ...
                      <TableCell>
                        <Select
                          value={door.swing_direction}
                          onValueChange={(v) =>
                            handleDoorChange(idx, "swing_direction", v)
                          }
                        >
                          <SelectTrigger className="min-w-[100px]">
                            <SelectValue />
                      ...
                      <TableCell>
                        <Select
                          value={door.construction_side}
                          onValueChange={(v) =>
                            handleDoorChange(idx, "construction_side", v)
                          }
                        >
                          <SelectTrigger className="min-w-[100px]">
                            <SelectValue />
                      ...
                      <TableCell>
                        <Select
                          value={door.threshold?.toString() || ""}
                          onValueChange={(v) =>
                            handleDoorChange(idx, "threshold", v)
                          }
                        >
                          <SelectTrigger className="min-w-[100px]">
                            <SelectValue />
                      ...
                      <TableCell>
                        <Select
                          value={door.casing_zamer}
                          onValueChange={(v) =>
                            handleDoorChange(idx, "casing_zamer", v)
                          }
                        >
                          <SelectTrigger className="min-w-[80px]">
                            <SelectValue />
                          ...
                          {door.extensions && door.extensions.length > 0 ? (
                            <div className="space-y-2">
                              ...
                              {door.extensions.map((ext, extIdx) => (
                                <div
                                  key={extIdx}
                                  className="flex gap-2 items-center p-2 bg-orange-50 rounded-lg border border-orange-200"
                                >
                                  <Input
                                    placeholder="W"
                                    type="number"
                                  ...
                                  <Button
                                    ...
                                    size="sm"
                                    onClick={() =>
                                      handleRemoveExtension(idx, extIdx)
                                    }
                          ...
                          {door.crowns && door.crowns.length > 0 ? (
                            <div className="space-y-2">
                              ...
                              {door.crowns.map((crown, crownIdx) => (
                                <div
                                  key={crownIdx}
                                  className="flex gap-2 items-center p-2 bg-purple-50 rounded-lg border border-purple-200"
                                >
                                  <Input
                                    placeholder="Qty"
                                    type="number"
                                  ...
                                  <Button
                                    ...
                                    size="sm"
                                    onClick={() =>
                                      handleRemoveCrown(idx, crownIdx)
                                    }
                                    className="h-7 w-7 p-0"
                                  >
                                    <Trash2 className="h-3 w-3" />
