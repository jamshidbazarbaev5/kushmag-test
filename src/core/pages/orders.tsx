        ...
        <div className="flex justify-between items-center">
          ...
          <div className="flex gap-2">
            ...
            <div className="relative" ref={statusDropdownRef}>
              ...
              {showStatusDropdown && (
                  <div
                      className="absolute top-full right-0 mt-1 w-64 bg-white border border-gray-200 rounded-lg shadow-lg z-50 max-h-60 overflow-y-auto">
                    <div className="p-3">
                      ...
                      <div className="space-y-2">
                        ...
                        >
                      <span
                          className="px-2 py-1 rounded text-xs font-medium flex-1 text-center bg-gray-100 text-gray-700">
                        Очистить фильтры
                      </span>
                        </div>
                          ...
                          <td className="px-3 py-2">
                            ...
                            >
                              ...
                              >
                                ...
                                {currentUser?.role !== "MANUFACTURE" && (
                                    <span
                                        className="ml-1 text-xs text-gray-400 opacity-0 group-hover:opacity-100 transition-opacity duration-200">
                              ✏️
                            </span>
                                )}
                              </div>
